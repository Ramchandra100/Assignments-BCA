...
userArea();
$n = $_SESSION['name'];
$res = pg_query($con, "SELECT category.name, expense.* FROM expense, users, category WHERE expense.categoryId = category.id AND expense.userId = users.id AND users.userName = '$n' ORDER BY eDate DESC");
$i = 1;
