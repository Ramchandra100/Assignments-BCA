...
check();
adminArea();
$res = mysqli_query($con, "SELECT COUNT(expense.id) as noOfE,users.userName,users.id as userId FROM expense,users WHERE expense.userId=users.id GROUP BY userName ORDER by noOfE ASC");
?>
