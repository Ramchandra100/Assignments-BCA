...
userArea();
$n = $_SESSION['name'];
$res = mysqli_query($con, "SELECT category.name,expense.* from expense,users,category where expense.categoryId=category.id and expense.userId=users.id and users.userName='$n' order by eDate DESC");
$i = 1;
