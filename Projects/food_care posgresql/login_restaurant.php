...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["register"])) {
    ...
    $checkEmail = $conn->prepare("SELECT id FROM restaurants WHERE email = :email");
    ...
    if ($result->num_rows > 0) {
        ...
        $insertStmt = $conn->prepare("INSERT INTO restaurants (name, email, phone, address, password) VALUES (:name, :email, :phone, :address, :password)");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["login"])) {
    ...
    $selectStmt = $conn->prepare("SELECT id, password FROM restaurants WHERE email = :email");
